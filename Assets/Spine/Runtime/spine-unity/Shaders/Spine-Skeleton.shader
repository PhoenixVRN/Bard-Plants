    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i) : SV_Target
            {
                ...
                #endif
                texColor.a *= i.vertexColor.a; // Учитываем альфа-канал вершины
                texColor.a *= _AlphaMultiplier; // Делаем объект полупрозрачным
                // texColor.a *= 0.6; // Делаем объект полупрозрачным
                return texColor;
